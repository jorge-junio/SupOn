...
<html>
    <head>
        ...
        if ($cpf != 0){
            $consulta = "INSERT INTO funcionario(cpf_f, nome, email, endereco, salario, telefone, cargo, senha) VALUES
            ('$cpf', '$nome', '$email', '$endereco', '$salario', '$telefone', '$cargo', '$senha')";
    ...
    <body>
        ...
        <nav><div class="container center"><div class="nav-wrapper">
            <div class="col s12">
                ...
                <a href="cadastrar_fun.php" class="breadcrumb">Cadastrar Funcionário</a>
            </div>
                </div></div></nav>
            ...
            <form class="col s8 offset-s2" method="get" action="cadastrar_fun.php">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <label><i class="material-icons left">phone</i>Telefone</label>
                    </div>
                </div>
