            ...
            <div>
                ...
                <form class="col s8 offset-s2" method="post" action="../controller/ItemCarrinhoController.php" id="for_fun">
                    ...
                    <div class="row">
                        ...
                        <button class="btn waves-effect waves-red col s3 offset-s2" type="submit" name="direcionaHome" value="direcionaHome" title="Cancelar Exclusão" ><i class="material-icons">cancel</i>
                        </button>
                    </div>
                </form>
            </div>
